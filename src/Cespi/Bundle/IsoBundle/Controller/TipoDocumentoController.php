...
use Cespi\Bundle\IsoBundle\Entity\TipoDocumento;
use Cespi\Bundle\IsoBundle\Form\TipoDocumentoType;
...
class TipoDocumentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CespiIsoBundle:TipoDocumento')->findAll();

        return $this->render('CespiIsoBundle:TipoDocumento:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CespiIsoBundle:TipoDocumento:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CespiIsoBundle:TipoDocumento')->find($id);
        ...
        return $this->render('CespiIsoBundle:TipoDocumento:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CespiIsoBundle:TipoDocumento:edit.html.twig', array(
            'entity'      => $entity,
